...
type BillingService interface {
	...
	CreateReportFile(ctx context.Context, in *CreateReportFileRequest, opts ...client.CallOption) (*CreateReportFileResponse, error)
	UpdateReportFile(ctx context.Context, in *UpdateReportFileRequest, opts ...client.CallOption) (*ResponseError, error)
	GetReportFile(ctx context.Context, in *GetReportFileRequest, opts ...client.CallOption) (*GetReportFileResponse, error)
	DeleteOldestReportFiles(ctx context.Context, in *DeleteOldestReportFilesRequest, opts ...client.CallOption) (*ResponseError, error)
}
...
func (c *billingService) CreateReportFile(ctx context.Context, in *CreateReportFileRequest, opts ...client.CallOption) (*CreateReportFileResponse, error) {
	req := c.c.NewRequest(c.name, "BillingService.CreateReportFile", in)
	out := new(CreateReportFileResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingService) UpdateReportFile(ctx context.Context, in *UpdateReportFileRequest, opts ...client.CallOption) (*ResponseError, error) {
	req := c.c.NewRequest(c.name, "BillingService.UpdateReportFile", in)
	out := new(ResponseError)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *billingService) GetReportFile(ctx context.Context, in *GetReportFileRequest, opts ...client.CallOption) (*GetReportFileResponse, error) {
	req := c.c.NewRequest(c.name, "BillingService.GetReportFile", in)
	out := new(GetReportFileResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingService) DeleteOldestReportFiles(ctx context.Context, in *DeleteOldestReportFilesRequest, opts ...client.CallOption) (*ResponseError, error) {
	req := c.c.NewRequest(c.name, "BillingService.DeleteOldestReportFiles", in)
	out := new(ResponseError)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type BillingServiceHandler interface {
	...
	CreateReportFile(context.Context, *CreateReportFileRequest, *CreateReportFileResponse) error
	UpdateReportFile(context.Context, *UpdateReportFileRequest, *ResponseError) error
	GetReportFile(context.Context, *GetReportFileRequest, *GetReportFileResponse) error
	DeleteOldestReportFiles(context.Context, *DeleteOldestReportFilesRequest, *ResponseError) error
}
...
func RegisterBillingServiceHandler(s server.Server, hdlr BillingServiceHandler, opts ...server.HandlerOption) error {
	type billingService interface {
		...
		CreateReportFile(ctx context.Context, in *CreateReportFileRequest, out *CreateReportFileResponse) error
		UpdateReportFile(ctx context.Context, in *UpdateReportFileRequest, out *ResponseError) error
		GetReportFile(ctx context.Context, in *GetReportFileRequest, out *GetReportFileResponse) error
		DeleteOldestReportFiles(ctx context.Context, in *DeleteOldestReportFilesRequest, out *ResponseError) error
	}
	type BillingService struct {
		billingService
	}
...
func (h *billingServiceHandler) CreateReportFile(ctx context.Context, in *CreateReportFileRequest, out *CreateReportFileResponse) error {
	return h.BillingServiceHandler.CreateReportFile(ctx, in, out)
}

func (h *billingServiceHandler) UpdateReportFile(ctx context.Context, in *UpdateReportFileRequest, out *ResponseError) error {
	return h.BillingServiceHandler.UpdateReportFile(ctx, in, out)
}

func (h *billingServiceHandler) GetReportFile(ctx context.Context, in *GetReportFileRequest, out *GetReportFileResponse) error {
	return h.BillingServiceHandler.GetReportFile(ctx, in, out)
}

func (h *billingServiceHandler) DeleteOldestReportFiles(ctx context.Context, in *DeleteOldestReportFilesRequest, out *ResponseError) error {
	return h.BillingServiceHandler.DeleteOldestReportFiles(ctx, in, out)
}
