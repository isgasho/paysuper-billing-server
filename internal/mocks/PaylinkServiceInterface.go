...
func (_m *PaylinkServiceInterface) GetById(ctx context.Context, id string) (*billingpb.Paylink, error) {
...
func (_m *PaylinkServiceInterface) GetByIdAndMerchant(ctx context.Context, id string, merchantId string) (*billingpb.Paylink, error) {
	ret := _m.Called(ctx, id, merchantId)
...
func (_m *PaylinkServiceInterface) GetListByQuery(ctx context.Context, query primitive.M, limit int64, offset int64) ([]*billingpb.Paylink, error) {
	ret := _m.Called(ctx, query, limit, offset)

	var r0 []*billingpb.Paylink
	if rf, ok := ret.Get(0).(func(context.Context, primitive.M, int64, int64) []*billingpb.Paylink); ok {
...
func (_m *PaylinkServiceInterface) Insert(ctx context.Context, pl *billingpb.Paylink) error {
...
func (_m *PaylinkServiceInterface) Update(ctx context.Context, pl *billingpb.Paylink) error {
	ret := _m.Called(ctx, pl)
