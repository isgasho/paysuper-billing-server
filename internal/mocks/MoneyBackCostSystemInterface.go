...
func (_m *MoneyBackCostSystemInterface) Delete(obj *billingpb.MoneyBackCostSystem) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*billingpb.MoneyBackCostSystem) error); ok {
		r0 = rf(obj)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MoneyBackCostSystemInterface) GetAll() (*billingpb.MoneyBackCostSystemList, error) {
	...
	if rf, ok := ret.Get(0).(func() *billingpb.MoneyBackCostSystemList); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *MoneyBackCostSystemInterface) GetById(id string) (*billingpb.MoneyBackCostSystem, error) {
	...
	if rf, ok := ret.Get(0).(func(string) *billingpb.MoneyBackCostSystem); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
