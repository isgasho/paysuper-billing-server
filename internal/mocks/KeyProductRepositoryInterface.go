...
func (_m *KeyProductRepositoryInterface) GetById(_a0 string) (*grpc.KeyProduct, error) {
	ret := _m.Called(_a0)

	var r0 *grpc.KeyProduct
	if rf, ok := ret.Get(0).(func(string) *grpc.KeyProduct); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *KeyProductRepositoryInterface) Update(_a0 *grpc.KeyProduct) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*grpc.KeyProduct) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
