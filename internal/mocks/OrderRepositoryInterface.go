...
func (_m *OrderRepositoryInterface) GetByProjectOrderId(_a0 context.Context, _a1 string, _a2 string) (*billing.Order, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *billing.Order
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *billing.Order); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billing.Order)
...
func (_m *OrderRepositoryInterface) Update(_a0 context.Context, _a1 *billing.Order) error {
	ret := _m.Called(_a0, _a1)
