...
func (_m *CountryRepositoryInterface) FindByHighRisk(ctx context.Context, isHighRiskOrder bool) (*billingpb.CountriesList, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, bool) *billingpb.CountriesList); ok {
...
func (_m *CountryRepositoryInterface) FindByVatEnabled(_a0 context.Context) (*billingpb.CountriesList, error) {
	...
	var r0 *billingpb.CountriesList
	if rf, ok := ret.Get(0).(func(context.Context) *billingpb.CountriesList); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billingpb.CountriesList)
...
func (_m *CountryRepositoryInterface) GetByIsoCodeA2(_a0 context.Context, _a1 string) (*billingpb.Country, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string) *billingpb.Country); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *CountryRepositoryInterface) Insert(_a0 context.Context, _a1 *billingpb.Country) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *billingpb.Country) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
