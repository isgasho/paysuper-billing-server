...
func (_m *PayoutDocumentServiceInterface) FindByQuery(ctx context.Context, query primitive.M, sorts []string, limit int64, offset int64) ([]*billingpb.PayoutDocument, error) {
	ret := _m.Called(ctx, query, sorts, limit, offset)

	var r0 []*billingpb.PayoutDocument
	if rf, ok := ret.Get(0).(func(context.Context, primitive.M, []string, int64, int64) []*billingpb.PayoutDocument); ok {
...
func (_m *PayoutDocumentServiceInterface) GetById(ctx context.Context, id string) (*billingpb.PayoutDocument, error) {
...
func (_m *PayoutDocumentServiceInterface) GetByIdAndMerchant(ctx context.Context, id string, merchantId string) (*billingpb.PayoutDocument, error) {
...
func (_m *PayoutDocumentServiceInterface) GetLast(ctx context.Context, merchantId string, currency string) (*billingpb.PayoutDocument, error) {
	ret := _m.Called(ctx, merchantId, currency)
...
func (_m *PayoutDocumentServiceInterface) Insert(ctx context.Context, document *billingpb.PayoutDocument, ip string, source string) error {
...
func (_m *PayoutDocumentServiceInterface) Update(ctx context.Context, document *billingpb.PayoutDocument, ip string, source string) error {
	ret := _m.Called(ctx, document, ip, source)
