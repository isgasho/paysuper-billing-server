...
func (_m *RefundRepositoryInterface) FindByOrderUuid(_a0 context.Context, _a1 string, _a2 int64, _a3 int64) ([]*billingpb.Refund, error) {
	...
	var r0 []*billingpb.Refund
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, int64) []*billingpb.Refund); ok {
		r0 = rf(_a0, _a1, _a2, _a3)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*billingpb.Refund)
		}
	}
...
func (_m *RefundRepositoryInterface) GetById(_a0 context.Context, _a1 string) (*billingpb.Refund, error) {
	...
	var r0 *billingpb.Refund
	if rf, ok := ret.Get(0).(func(context.Context, string) *billingpb.Refund); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billingpb.Refund)
...
func (_m *RefundRepositoryInterface) Insert(_a0 context.Context, _a1 *billingpb.Refund) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *billingpb.Refund) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
