...
func (_m *MerchantRepositoryInterface) UpdateTariffs(ctx context.Context, id string, req *billing.PaymentChannelCostMerchant) error {
	ret := _m.Called(ctx, id, req)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *billing.PaymentChannelCostMerchant) error); ok {
		r0 = rf(ctx, id, req)
	} else {
		r0 = ret.Error(0)
	}
