...
func (_m *KeyRepositoryInterface) CancelById(_a0 context.Context, _a1 string) (*billing.Key, error) {
	...
	var r0 *billing.Key
	if rf, ok := ret.Get(0).(func(context.Context, string) *billing.Key); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *KeyRepositoryInterface) FindUnfinished(_a0 context.Context) ([]*billing.Key, error) {
	...
	var r0 []*billing.Key
	if rf, ok := ret.Get(0).(func(context.Context) []*billing.Key); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*billing.Key)
...
func (_m *KeyRepositoryInterface) Insert(_a0 context.Context, _a1 *billing.Key) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *billing.Key) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *KeyRepositoryInterface) ReserveKey(_a0 context.Context, _a1 string, _a2 string, _a3 string, _a4 int32) (*billing.Key, error) {
	...
	var r0 *billing.Key
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, int32) *billing.Key); ok {
