...
func (suite *BillingServiceTestSuite) SetupTest() {
	...
	suite.service = NewBillingService(db, cfg, mocks.NewGeoIpServiceTestOk(), mocks.NewRepositoryServiceOk(), mocks.NewTaxServiceOkMock(), broker, nil, NewCacheRedis(redisdb), mocks.NewCurrencyServiceMockOk(), mocks.NewDocumentSignerMockOk(), nil, nil)
...
func (suite *BillingServiceTestSuite) TestNewBillingService() {
	...
	service := NewBillingService(suite.db, suite.cfg, nil, nil, nil, nil, nil, suite.cache, mocks.NewCurrencyServiceMockOk(), mocks.NewDocumentSignerMockOk(), nil, nil)
...
func (suite *BillingServiceTestSuite) TestBillingService_AccountingCurrencyInitError() {
	...
	service := NewBillingService(suite.db, cfg, nil, nil, nil, nil, nil, suite.cache, mocks.NewCurrencyServiceMockError(), mocks.NewDocumentSignerMockOk(), nil, nil)
